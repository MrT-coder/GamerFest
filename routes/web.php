...
// Rutas agregadas para pruebas
Route::post('/registrar-juego', [JuegoController::class, 'registrarJuego'])->middleware('auth');
Route::post('/buscar-usuario', [UsuarioController::class, 'buscarUsuario'])->middleware('auth');
