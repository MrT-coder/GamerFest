            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="hora_inicio" type="datetime-local" class="form-control" id="hora_inicio"
                            placeholder="Fecha y Hora">
                        @error('hora_inicio')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="hora_fin" type="datetime-local" class="form-control" id="hora_fin"
                            placeholder="Fecha y Hora">
                        @error('hora_fin')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
