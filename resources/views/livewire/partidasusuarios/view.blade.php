			...
			<div class="card">
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						...
						<i class="fa fa-plus"></i>  Add Partidasusuarios
						</div>
					</div>
				</div>
								...
								<td width="90">
									<div class="dropdown">
										...
										<ul class="dropdown-menu">
											...
											<li><a class="dropdown-item" onclick="confirm('Confirm Delete Partidasusuario id {{$row->id}}? \nDeleted Partidasusuarios cannot be recovered!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Delete </a></li>  
										</ul>
									</div>								
								</td>
							</tr>
