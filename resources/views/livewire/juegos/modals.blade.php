            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="costo" type="text" class="form-control" id="costo"
                            placeholder="Costo">
                        @error('costo')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="ruta_foto_principal" type="text" class="form-control"
                            id="ruta_foto_principal" placeholder="Ruta Foto Principal">
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="ruta_foto_portada" type="text" class="form-control" id="ruta_foto_portada"
                            placeholder="Ruta Foto Portada">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="ruta_foto_portada"></label>
                        <input wire:model="ruta_foto_portada" type="text" class="form-control"
                            id="ruta_foto_portada" placeholder="Ruta Foto Portada">
                        @error('ruta_foto_portada')
                            <span class="error text-danger">{{ $message }}</span>
                        @enderror
                    </div>
