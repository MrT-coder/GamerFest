							...
							<tr>
								...
								<td class="text-center align-middle">
									<div>
											...
											<a class="btn btn-sm btn-danger m-1" onclick="confirm('¿Desea eliminar el Juego con ID {{$row->id}}? \n¡No se pueden recuperar los Juegos eliminados!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Eliminar </a>  
										</ul>
									</div>								
								</td>
							</tr>
