                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input wire:model="telefono" type="tel" class="form-control" id="telefono" placeholder="Celular" maxlength="10">@error('telefono') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input wire:model="universidad" type="text" class="form-control" id="universidad" placeholder="ESPE">@error('universidad') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="carrera">Carrera</label>
                                <input wire:model="carrera" type="text" class="form-control" id="carrera" placeholder="Software">@error('carrera') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input wire:model="semestre" type="number" class="form-control" id="semestre" placeholder="Ingresa un número">@error('semestre') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="email">Correo electrónico</label>
                                <input wire:model="email" type="email" class="form-control" id="email" placeholder="ejemplo@ejemplo.com">@error('email') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input wire:model="pass" type="password" class="form-control" id="pass" placeholder="Mínimo 8 caracteres">@error('pass') <span class="error text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
