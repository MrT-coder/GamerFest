				...
				<div class="card-header">
					<div style="display: flex; justify-content: space-between; align-items: center;">
						<div class="float-left">
							<h4><i class="fa-solid fa-people-group"></i>
							Lista de Equipos</h4>
						</div>
							...
							<tr>
								...
								<td class="text-center align-middle">
									<div>
											...
											<a class="btn btn-sm btn-danger m-1" onclick="confirm('¿Desea eliminar el Equipo con ID {{$row->id}}? \n¡No se pueden recuperar los Equipos eliminados!')||event.stopImmediatePropagation()" wire:click="destroy({{$row->id}})"><i class="fa fa-trash"></i> Eliminar </a>  
										</ul>
									</div>								
								</td>
							</tr>
