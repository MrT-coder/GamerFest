<header class="absolute text-gray-400 bg-transparent body-font w-full h-full md:h-0">
    <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <a href="{{ route('login') }}">
            <button
                class="block w-1/2 px-3 py-2 mx-1 rounded-full text-center text-lg bg-purple-800 hover:bg-purple-600 text-white font-bold my-2 py-2 px-4 rounded-full transition-all duration-300 border-2 border-transparent hover:border-white focus:outline-none focus:ring focus:border-purple-300 font-medium text-white leading-5 md:mx-2 md:w-auto ">
                Ingresar
            </button>
        </a>
